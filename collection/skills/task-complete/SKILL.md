...
- Validation, review, and documentation maintenance gates are complete, skipped with reasons, or blocked.

If the plan or required output evidence is missing, report closure as blocked instead of inferring completion.
