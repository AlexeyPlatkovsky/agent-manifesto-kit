...
- Do not create or edit feature folders, rebuild `INDEX.md`, or invent facts. Work and feature
  records belong in Taskpilot and are handled by `sdd-feature-author`.
