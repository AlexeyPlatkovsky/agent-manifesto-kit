...
- **Frontmatter mapping:** which `.collection/`-source fields are kept verbatim, which are renamed, which are dropped. The `.ai/` form should be the most neutral, vendor-free expression of the asset.
