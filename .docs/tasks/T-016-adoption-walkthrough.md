...
1. **Claude direct path:**
   - Source: `.skill_kit/skills/task-explorer/` and `.skill_kit/agents/code-reviewer/` in the kit
   - Action: copy folders into consumer's `.skill_kit/skills/` and `.skill_kit/agents/`
